                        ...
                        {type === 'student' && (
                            <>
                                ...
                                <div className="form-group mb-lg">
                                    ...
                                    <input type="tel" className="form-input" placeholder="9876543210" pattern="[0-9]{10}" value={parentPhone} onChange={e => setParentPhone(e.target.value)} required />
                            ...
                            <>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }} className="mb-lg">
                                    ...
                                    <div className="form-group mb-sm">
                                        ...
                                        <input type="tel" className="form-input" placeholder="9876543210" pattern="[0-9]{10}" value={contactNumber} onChange={e => setContactNumber(e.target.value)} />
                                    </div>
                                </div>
                            </>
                        )}
