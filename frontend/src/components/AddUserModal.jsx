                        ...
                        {type === 'student' && (
                            <>
                                ...
                                <div className="form-group mb-lg">
                                    ...
                                    <input type="tel" pattern="[0-9]{10}" title="Must be exactly 10 digits" className="form-input" placeholder="9876543210" value={parentPhone} onChange={e => setParentPhone(e.target.value)} required />
