...
const StudentsPanel = ({ students, onAddStudent, nextCursor, onLoadMore, isLoadingMore }) => (
                ...
                <table className="data-table">
                    ...
                    <tbody>
                        {students.length > 0 ? students.map(st => (
                            ...
                            <tr><td colSpan="5" className="empty-state">No students found. Add a student to get started.</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
